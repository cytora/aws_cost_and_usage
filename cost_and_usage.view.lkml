view: cost_and_usage {
  sql_table_name: athenacurcfn_cytora_looker_billing_dashboard.cytora_looker_billing_dashboard ;;
  suggestions: no
...
#     map_layer_name: countries
  ...
  dimension: from_location_lat {
    ...
    sql: CASE
        ...
        WHEN ${TABLE}.product_from_locationproduct_from_location = 'Japan' THEN '36.204824'
        WHEN ${TABLE}.product_from_locationproduct_from_location = 'South America (Sao Paulo)' THEN '-23.550520'
        WHEN ${TABLE}.product_from_locationproduct_from_location = 'South America' THEN '-23.550520'
        WHEN ${TABLE}.product_from_locationproduct_from_location = 'US East (N. Virginia)' THEN '37.431573'
        WHEN ${TABLE}.product_from_locationproduct_from_location = 'US East (Ohio)' THEN '40.417287'
        WHEN ${TABLE}.product_from_locationproduct_from_location = 'US West (N. California)' THEN '38.837522'
        WHEN ${TABLE}.product_from_locationproduct_from_location = 'US WEST (Oregon)' THEN '43.804133'
        ELSE 'Not labeled'
        END
        ;;
  }
  ...
  dimension: product_preinstalledsw {
    type: string
    hidden: yes
    sql: ${TABLE}.product_preinstalled_sw ;;
  }
